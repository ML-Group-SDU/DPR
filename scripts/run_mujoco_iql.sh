...
for ((seed=0; seed<5; seed+=1))
do
    name=CS-TFM-IQL-Hopper-medium-v2-51
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=hopper
    dataset=medium_v2
...
for ((seed=0; seed<5; seed+=1))
do
    name=CS-TFM-IQL-Hopper-medium-replay-v2-51
    mkdir -p ./logs/$name
    device="cuda:1"
    env_type=hopper
    dataset=medium_replay_v2
...
for ((seed=0; seed<5; seed+=1))
do
    name=CS-TFM-IQL-Hopper-medium-expert-v2-51
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=hopper
    dataset=medium_expert_v2
...
for ((seed=0; seed<5; seed+=1))
do
    name=CS-TFM-IQL-Walker2d-medium-v2-51
    mkdir -p ./logs/$name
    device="cuda:1"
    env_type=walker2d
    dataset=medium_v2
...
for ((seed=0; seed<5; seed+=1))
do
    name=CS-TFM-IQL-Walker2d-medium-replay-v-51
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=walker2d
    dataset=medium_replay_v2
...
for ((seed=0; seed<5; seed+=1))
do
    name=CS-TFM-IQL-Walker2d-medium-expert-v2-51
    mkdir -p ./logs/$name
    device="cuda:1"
    env_type=walker2d
    dataset=medium_expert_v2
...
for ((seed=0; seed<5; seed+=1))
do
    name=CS-TFM-IQL-Halfcheetah-medium-v2-51
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=halfcheetah
    dataset=medium_v2
...
for ((seed=0; seed<5; seed+=1))
do
    name=CS-TFM-IQL-Halfcheetah-medium-replay-v2-51
    mkdir -p ./logs/$name
    device="cuda:1"
    env_type=halfcheetah
    dataset=medium_replay_v2
...
for ((seed=0; seed<5; seed+=1))
do
    name=CS-TFM-IQL-Halfcheetah-medium-expert-v2-51
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=halfcheetah
    dataset=medium_expert_v2
    reward_model_path="./rlhf/reward_model_logs/halfcheetah-medium-expert-v2/CS-TFM/epoch_800_query_2000_len_200_seed_999/models/reward_model.pt"
    reward_model_type=transformer
    config_path=./configs/offline/iql/$env_type/$dataset.yaml
    nohup python -u algorithms/offline/iql_p.py --device $device --seed $seed \
    --reward_model_path $reward_model_path --config_path $config_path \
...
do
    name=CS-DPR-IQL-Hopper-medium-v2
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=hopper
    dataset=medium_v2
...
for ((seed=0; seed<3; seed+=1))
do
    name=CS-DPR-IQL-Hopper-medium-replay-v2
    mkdir -p ./logs/$name
    device="cuda:1"
    env_type=hopper
    dataset=medium_replay_v2
...
for ((seed=0; seed<3; seed+=1))
do
    name=CS-DPR-IQL-Hopper-medium-expert-v2
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=hopper
    dataset=medium_expert_v2
...
for ((seed=0; seed<3; seed+=1))
do
    name=CS-DPR-IQL-Walker2d-medium-v2
    mkdir -p ./logs/$name
    device="cuda:1"
    env_type=walker2d
    dataset=medium_v2
...
for ((seed=0; seed<3; seed+=1))
do
    name=CS-DPR-IQL-Walker2d-medium-replay-v2
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=walker2d
    dataset=medium_replay_v2
    reward_model_path="./rlhf/reward_model_logs/walker2d-medium-replay-v2/CS-DPR/epoch_500_query_2000_len_200_seed_999/models/reward_model.pt"
    reward_model_type=DPR
    config_path=./configs/offline/iql/$env_type/$dataset.yaml
    nohup python -u algorithms/offline/iql_p.py --device $device --seed $seed \
    --reward_model_path $reward_model_path --config_path $config_path \
...
for ((seed=0; seed<3; seed+=1))
do
    name=CS-DPR-IQL-Walker2d-medium-expert-v2
    mkdir -p ./logs/$name
    device="cuda:1"
    env_type=walker2d
    dataset=medium_expert_v2
...
for ((seed=0; seed<3; seed+=1))
do
    name=CS-DPR-IQL-Halfcheetah-medium-v2
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=halfcheetah
    dataset=medium_v2
...
for ((seed=0; seed<3; seed+=1))
do
    name=CS-DPR-IQL-Halfcheetah-medium-replay-v2
    mkdir -p ./logs/$name
    device="cuda:1"
    env_type=halfcheetah
    dataset=medium_replay_v2
...
for ((seed=0; seed<3; seed+=1))
do
    name=CS-DPR-IQL-Halfcheetah-medium-expert-v2
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=halfcheetah
    dataset=medium_expert_v2
...
for ((seed=0; seed<3; seed+=1))
do
    name=CS-CDPR-IQL-Hopper-medium-v2
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=hopper
    dataset=medium_v2
...
for ((seed=0; seed<3; seed+=1))
do
    name=CS-CDPR-IQL-Hopper-medium-replay-v2
    mkdir -p ./logs/$name
    device="cuda:1"
    env_type=hopper
    dataset=medium_replay_v2
...
for ((seed=0; seed<3; seed+=1))
do
    name=CS-CDPR-IQL-Hopper-medium-expert-v2
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=hopper
    dataset=medium_expert_v2
...
for ((seed=0; seed<3; seed+=1))
do
    name=CS-CDPR-IQL-Walker2d-medium-v2
    mkdir -p ./logs/$name
    device="cuda:1"
    env_type=walker2d
    dataset=medium_v2
...
for ((seed=0; seed<3; seed+=1))
do
    name=CS-CDPR-IQL-Walker2d-medium-replay-v2
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=walker2d
    dataset=medium_replay_v2
...
for ((seed=0; seed<3; seed+=1))
do
    name=CS-CDPR-IQL-Walker2d-medium-expert-v2
    mkdir -p ./logs/$name
    device="cuda:1"
    env_type=walker2d
    dataset=medium_expert_v2
...
for ((seed=0; seed<3; seed+=1))
do
    name=CS-CDPR-IQL-Halfcheetah-medium-v2
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=halfcheetah
    dataset=medium_v2
...
for ((seed=0; seed<3; seed+=1))
do
    name=CS-CDPR-IQL-Halfcheetah-medium-replay-v2
    mkdir -p ./logs/$name
    device="cuda:1"
    env_type=halfcheetah
    dataset=medium_replay_v2
...
for ((seed=0; seed<3; seed+=1))
do
    name=CS-CDPR-IQL-Halfcheetah-medium-expert-v2
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=halfcheetah
    dataset=medium_expert_v2
