...
do
    name=CS-MLP-CQL-Hopper-medium-v2
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=hopper
    dataset=medium_v2
    ...
    config_path=./configs/offline/cql/$env_type/$dataset.yaml
    nohup python -u algorithms/offline/cql_p.py --device $device --seed $seed \
...
for ((seed=0; seed<5; seed+=1))
do
    name=CS-MLP-CQL-Hopper-medium-replay-v2
    mkdir -p ./logs/$name
    device="cuda:1"
    env_type=hopper
...
for ((seed=0; seed<5; seed+=1))
do
    name=CS-MLP-CQL-Hopper-medium-expert-v2
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=hopper
...
for ((seed=0; seed<5; seed+=1))
do
    name=CS-MLP-CQL-Walker2d-medium-v2
    mkdir -p ./logs/$name
    device="cuda:1"
    env_type=walker2d
    dataset=medium_v2
...
for ((seed=0; seed<5; seed+=1))
do
    name=CS-MLP-CQL-Walker2d-medium-replay-v2
    mkdir -p ./logs/$name
    device="cuda:2"
    env_type=walker2d
    dataset=medium_replay_v2
...
for ((seed=0; seed<5; seed+=1))
do
    name=CS-MLP-CQL-Walker2d-medium-expert-v2
    mkdir -p ./logs/$name
    device="cuda:3"
    env_type=walker2d
    dataset=medium_expert_v2
...
for ((seed=0; seed<5; seed+=1))
do
    name=CS-MLP-CQL-Halfcheetah-medium-v2
    mkdir -p ./logs/$name
    device="cuda:4"
...
for ((seed=0; seed<5; seed+=1))
do
    name=CS-MLP-CQL-Halfcheetah-medium-replay-v2
    mkdir -p ./logs/$name
    device="cuda:4"
    env_type=halfcheetah
    dataset=medium_replay_v2
...
for ((seed=0; seed<5; seed+=1))
do
    name=CS-MLP-CQL-Halfcheetah-medium-expert-v2
    mkdir -p ./logs/$name
    device="cuda:5"
    env_type=halfcheetah
    dataset=medium_expert_v2
...
for ((seed=0; seed<5; seed+=1))
do
    name=CS-TFM-CQL-Hopper-medium-v2-51
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=hopper
    dataset=medium_v2
...
for ((seed=0; seed<5; seed+=1))
do
    name=CS-TFM-CQL-Hopper-medium-replay-v2-51
    mkdir -p ./logs/$name
    device="cuda:1"
    env_type=hopper
    dataset=medium_replay_v2
...
for ((seed=0; seed<5; seed+=1))
do
    name=CS-TFM-CQL-Hopper-medium-expert-v2-51
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=hopper
    dataset=medium_expert_v2
...
for ((seed=0; seed<5; seed+=1))
do
    name=CS-TFM-CQL-Walker2d-medium-v2-51
    mkdir -p ./logs/$name
    device="cuda:1"
    env_type=walker2d
    dataset=medium_v2
...
for ((seed=0; seed<5; seed+=1))
do
    name=CS-TFM-CQL-Walker2d-medium-replay-v-51
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=walker2d
    dataset=medium_replay_v2
...
for ((seed=0; seed<5; seed+=1))
do
    name=CS-TFM-CQL-Walker2d-medium-expert-v2-51
    mkdir -p ./logs/$name
    device="cuda:1"
    env_type=walker2d
    dataset=medium_expert_v2
...
for ((seed=0; seed<5; seed+=1))
do
    name=CS-TFM-CQL-Halfcheetah-medium-v2-51
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=halfcheetah
    dataset=medium_v2
...
for ((seed=0; seed<5; seed+=1))
do
    name=CS-TFM-CQL-Halfcheetah-medium-replay-v2-51
    mkdir -p ./logs/$name
    device="cuda:1"
    env_type=halfcheetah
    dataset=medium_replay_v2
...
for ((seed=0; seed<5; seed+=1))
do
    name=CS-TFM-CQL-Halfcheetah-medium-expert-v2-51
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=halfcheetah
    dataset=medium_expert_v2
...
do
    name=CS-DPR-CQL-Hopper-medium-v2
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=hopper
    dataset=medium_v2
...
for ((seed=0; seed<3; seed+=1))
do
    name=CS-DPR-CQL-Hopper-medium-replay-v2
    mkdir -p ./logs/$name
    device="cuda:1"
    env_type=hopper
    dataset=medium_replay_v2
...
for ((seed=0; seed<3; seed+=1))
do
    name=CS-DPR-CQL-Hopper-medium-expert-v2
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=hopper
    dataset=medium_expert_v2
...
for ((seed=0; seed<3; seed+=1))
do
    name=CS-DPR-CQL-Walker2d-medium-v2
    mkdir -p ./logs/$name
    device="cuda:1"
    env_type=walker2d
    dataset=medium_v2
...
for ((seed=0; seed<3; seed+=1))
do
    name=CS-DPR-CQL-Walker2d-medium-replay-v2
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=walker2d
    dataset=medium_replay_v2
...
for ((seed=0; seed<3; seed+=1))
do
    name=CS-DPR-CQL-Walker2d-medium-expert-v2
    mkdir -p ./logs/$name
    device="cuda:1"
    env_type=walker2d
    dataset=medium_expert_v2
...
for ((seed=0; seed<3; seed+=1))
do
    name=CS-DPR-CQL-Halfcheetah-medium-v2
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=halfcheetah
    dataset=medium_v2
...
for ((seed=0; seed<3; seed+=1))
do
    name=CS-DPR-CQL-Halfcheetah-medium-replay-v2
    mkdir -p ./logs/$name
    device="cuda:1"
    env_type=halfcheetah
    dataset=medium_replay_v2
...
for ((seed=0; seed<3; seed+=1))
do
    name=CS-DPR-CQL-Halfcheetah-medium-expert-v2
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=halfcheetah
    dataset=medium_expert_v2
...
for ((seed=0; seed<3; seed+=1))
do
    name=CS-CDPR-CQL-Hopper-medium-v2
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=hopper
    dataset=medium_v2
...
for ((seed=0; seed<3; seed+=1))
do
    name=CS-CDPR-CQL-Hopper-medium-replay-v2
    mkdir -p ./logs/$name
    device="cuda:1"
    env_type=hopper
    dataset=medium_replay_v2
...
for ((seed=0; seed<3; seed+=1))
do
    name=CS-CDPR-CQL-Hopper-medium-expert-v2
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=hopper
    dataset=medium_expert_v2
...
for ((seed=0; seed<3; seed+=1))
do
    name=CS-CDPR-CQL-Walker2d-medium-v2
    mkdir -p ./logs/$name
    device="cuda:1"
    env_type=walker2d
    dataset=medium_v2
...
for ((seed=0; seed<3; seed+=1))
do
    name=CS-CDPR-CQL-Walker2d-medium-replay-v2
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=walker2d
    dataset=medium_replay_v2
...
for ((seed=0; seed<3; seed+=1))
do
    name=CS-CDPR-CQL-Walker2d-medium-expert-v2
    mkdir -p ./logs/$name
    device="cuda:1"
    env_type=walker2d
    dataset=medium_expert_v2
...
for ((seed=0; seed<3; seed+=1))
do
    name=CS-CDPR-CQL-Halfcheetah-medium-v2
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=halfcheetah
    dataset=medium_v2
...
for ((seed=0; seed<3; seed+=1))
do
    name=CS-CDPR-CQL-Halfcheetah-medium-replay-v2
    mkdir -p ./logs/$name
    device="cuda:1"
    env_type=halfcheetah
    dataset=medium_replay_v2
...
for ((seed=0; seed<3; seed+=1))
do
    name=CS-CDPR-CQL-Halfcheetah-medium-expert-v2
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=halfcheetah
    dataset=medium_expert_v2
