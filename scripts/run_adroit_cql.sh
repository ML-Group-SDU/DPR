...
for ((seed=0; seed<3; seed+=1))
do
    name=CS-MLP-CQL-Door-cloned-v1
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=door
    dataset=cloned_v1
...
for ((seed=0; seed<3; seed+=1))
do
    name=CS-MLP-CQL-Hammer-human-v1
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=hammer
    dataset=human_v1
...
for ((seed=0; seed<3; seed+=1))
do
    name=CS-MLP-CQL-Hammer-cloned-v1
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=hammer
    dataset=cloned_v1
...
for ((seed=0; seed<3; seed+=1))
do
    name=CS-TFM-CQL-Door-cloned-v1
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=door
    dataset=cloned_v1
...
for ((seed=0; seed<3; seed+=1))
do
    name=CS-TFM-CQL-Hammer-human-v1
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=hammer
    dataset=human_v1
...
for ((seed=0; seed<3; seed+=1))
do
    name=CS-TFM-CQL-Hammer-cloned-v1
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=hammer
    dataset=cloned_v1
...
# CS-DPR-CQL-Pen-human-v1
export CUDA_VISIBLE_DEVICES=0
for ((seed=0; seed<5; seed+=1))
do
    name=CS-DPR-CQL-Pen-human-v1
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=pen
    dataset=human_v1
...
# CS-DPR-CQL-Pen-cloned-v1
export CUDA_VISIBLE_DEVICES=0
for ((seed=0; seed<5; seed+=1))
do
    name=CS-DPR-CQL-Pen-cloned-v1
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=pen
    dataset=cloned_v1
...
# CS-DPR-CQL-Door-human-v1
export CUDA_VISIBLE_DEVICES=0
for ((seed=0; seed<3; seed+=1))
do
    name=CS-DPR-CQL-Door-human-v1
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=door
    dataset=human_v1
...
# CS-DPR-CQL-Door-cloned-v1
export CUDA_VISIBLE_DEVICES=0
for ((seed=0; seed<3; seed+=1))
do
    name=CS-DPR-CQL-Door-cloned-v1
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=door
    dataset=cloned_v1
...
# CS-DPR-CQL-Hammer-human-v1
export CUDA_VISIBLE_DEVICES=0
for ((seed=0; seed<3; seed+=1))
do
    name=CS-DPR-CQL-Hammer-human-v1
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=hammer
    dataset=human_v1
...
# CS-DPR-CQL-Hammer-cloned-v1
export CUDA_VISIBLE_DEVICES=0
for ((seed=0; seed<3; seed+=1))
do
    name=CS-DPR-CQL-Hammer-cloned-v1
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=hammer
    dataset=cloned_v1
...
# CS-CDPR-CQL-Pen-human-v1
export CUDA_VISIBLE_DEVICES=0
for ((seed=0; seed<5; seed+=1))
do
    name=CS-CDPR-CQL-Pen-human-v1
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=pen
    dataset=human_v1
...
# CS-CDPR-CQL-Pen-cloned-v1
export CUDA_VISIBLE_DEVICES=0
for ((seed=0; seed<5; seed+=1))
do
    name=CS-CDPR-CQL-Pen-cloned-v1
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=pen
    dataset=cloned_v1
...
# CS-CDPR-CQL-Door-human-v1
export CUDA_VISIBLE_DEVICES=0
for ((seed=0; seed<3; seed+=1))
do
    name=CS-CDPR-CQL-Door-human-v1
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=door
    dataset=human_v1
...
# CS-CDPR-CQL-Door-cloned-v1
export CUDA_VISIBLE_DEVICES=0
for ((seed=0; seed<3; seed+=1))
do
    name=CS-CDPR-CQL-Door-cloned-v1
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=door
    dataset=cloned_v1
...
# CS-CDPR-CQL-Hammer-human-v1
export CUDA_VISIBLE_DEVICES=0
for ((seed=0; seed<3; seed+=1))
do
    name=CS-CDPR-CQL-Hammer-human-v1
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=hammer
    dataset=human_v1
...
# CS-CDPR-CQL-Hammer-cloned-v1
export CUDA_VISIBLE_DEVICES=0
for ((seed=0; seed<3; seed+=1))
do
    name=CS-CDPR-CQL-Hammer-cloned-v1
    mkdir -p ./logs/$name
    device="cuda:0"
    env_type=hammer
    dataset=cloned_v1
